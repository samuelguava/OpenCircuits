...
<html>
    <head>
        ...
        <script src="https://unpkg.com/driver.js@0.8.1/dist/driver.min.js"></script>
        <link rel="stylesheet" href="https://unpkg.com/driver.js@0.8.1/dist/driver.min.css">
            ...
            <header id="header">
                ...
                <div class="header__right">
                    ...
                    <button type="button" onclick="Tour.start();">
                        <img src="img/icons/open.svg" height="100%" alt="Start Tour" />
                    </button>
                </div>
            </header>
